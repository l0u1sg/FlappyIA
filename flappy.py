...
BIRD_IMG = [pygame.transform.scale2x(
    pygame.image.load(os.path.join("img", "bird1.png"))), pygame.transform.scale2x(
    pygame.image.load(os.path.join("img", "bird2.png"))), pygame.transform.scale2x(
...
class Bird:
    ...
    def draw(self, win):
        ...
        new_rect = rotated_image.get_rect(
            center=self.img.get-rect(topleft=(self.x, self.y)).center)
